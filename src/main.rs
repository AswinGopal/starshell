...
use rand::RngExt;
use starshell::context::{Context, Properties, Target};
use starshell::module::ALL_MODULES;
use starshell::{bug_report, configure, init, logger, num_rayon_threads, print, shadow};
...
#[clap(
    ...
    about="A minimal, fast shell prompt.",
